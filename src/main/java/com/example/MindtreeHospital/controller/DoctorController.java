package com.example.MindtreeHospital.controller;
...
import com.example.MindtreeHospital.service.DoctorService;
...
public class DoctorController {
	    ...
	    @ExceptionHandler(value = com.example.MindtreeHospital.exception.DoctorExist.class)
		public ResponseEntity<String> DoctorExist(
				com.example.MindtreeHospital.exception.DoctorExist ExistExp) {
